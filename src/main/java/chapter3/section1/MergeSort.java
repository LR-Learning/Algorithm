...
public class MergeSort {
    ...
    public static void main(String[] args) {
        ...
        // 测试数组是否有序
        SortTestHelper.testSort("chapter3.section1.MergeSort", arr);
        chapter1.section6InsertionSortOptimize.SortTestHelper.testSort("chapter1.section5InsertionSort.SelectionSort", arr);
    }
